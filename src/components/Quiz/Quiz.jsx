...
import StoneModelStep from "./StoneModelStep";
...
const steps = ["stoneModel", "color", "quantity", "contact"];
...
export default function Quiz() {
  ...
  const renderStep = () => {
    if (currentStep === "stoneModel") {
      return <StoneModelStep formData={formData} onFieldChange={updateField} error={errors.stoneModel} />;
    }

    if (currentStep === "color") {
      return <ColorStep formData={formData} onFieldChange={updateField} error={errors.color} />;
    }

    if (currentStep === "quantity") {
      return <QuantityStep formData={formData} onFieldChange={updateField} errors={errors} />;
    }
