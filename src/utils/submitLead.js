...
export async function submitLead(leadData) {
  ...
  const fullName = [contact.lastName, contact.firstName, contact.middleName].filter(Boolean).join(" ");
  const subject = `${EMAIL_SETTINGS_PLACEHOLDER.subject}: ${fullName || "Без имени"}`;
